...
This is not a "general purpose" assembler in the sense that it can be used widely, but rather a "general" assembler in the sense that it is "common to all" processors but not very complex architecture processor. That is, axx.py does not support some vliw processors that have meta-level bundling of instructions.
