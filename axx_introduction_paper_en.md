...
A tokenizer-less DSL with free-form syntax is unprecedented. (Proving that it is unprecedented is impossible, however, as it would require examining every single existing example.)
