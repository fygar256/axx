...
(A tokenizer-less free-syntax DSL might be unprecedented, but proving that it is unprecedented is impossible, as it would require examining every single existing case.)
